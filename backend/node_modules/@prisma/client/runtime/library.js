"use strict";var Ol=Object.create;var Rt=Object.defineProperty;var Fl=Object.getOwnPropertyDescriptor;var Ml=Object.getOwnPropertyNames;var $l=Object.getPrototypeOf,ql=Object.prototype.hasOwnProperty;var X=(e,r)=>()=>(r||e((r={exports:{}}).exports,r),r.exports),Or=(e,r)=>{for(var t in r)Rt(e,t,{get:r[t],enumerable:!0})},no=(e,r,t,n)=>{if(r&&typeof r=="object"||typeof r=="function")for(let i of Ml(r))!ql.call(e,i)&&i!==t&&Rt(e,i,{get:()=>r[i],enumerable:!(n=Fl(r,i))||n.enumerable});return e};var _=(e,r,t)=>(t=e!=null?Ol($l(e)):{},no(r||!e||!e.__esModule?Rt(t,"default",{value:e,enumerable:!0}):t,e)),Bl=e=>no(Rt({},"__esModule",{value:!0}),e);var Ao=X((Ld,Un)=>{"use strict";var v=Un.exports;Un.exports.default=v;var D="\x1B[",Vr="\x1B]",dr="\x07",Ft=";",Ro=process.env.TERM_PROGRAM==="Apple_Terminal";v.cursorTo=(e,r)=>{if(typeof e!="number")throw new TypeError("The `x` argument is required");return typeof r!="number"?D+(e+1)+"G":D+(r+1)+";"+(e+1)+"H"};v.cursorMove=(e,r)=>{if(typeof e!="number")throw new TypeError("The `x` argument is required");let t="";return e<0?t+=D+-e+"D":e>0&&(t+=D+e+"C"),r<0?t+=D+-r+"A":r>0&&(t+=D+r+"B"),t};v.cursorUp=(e=1)=>D+e+"A";v.cursorDown=(e=1)=>D+e+"B";v.cursorForward=(e=1)=>D+e+"C";v.cursorBackward=(e=1)=>D+e+"D";v.cursorLeft=D+"G";v.cursorSavePosition=Ro?"\x1B7":D+"s";v.cursorRestorePosition=Ro?"\x1B8":D+"u";v.cursorGetPosition=D+"6n";v.cursorNextLine=D+"E";v.cursorPrevLine=D+"F";v.cursorHide=D+"?25l";v.cursorShow=D+"?25h";v.eraseLines=e=>{let r="";for(let t=0;t<e;t++)r+=v.eraseLine+(t<e-1?v.cursorUp():"");return e&&(r+=v.cursorLeft),r};v.eraseEndLine=D+"K";v.eraseStartLine=D+"1K";v.eraseLine=D+"2K";v.eraseDown=D+"J";v.eraseUp=D+"1J";v.eraseScreen=D+"2J";v.scrollUp=D+"S";v.scrollDown=D+"T";v.clearScreen="\x1Bc";v.clearTerminal=process.platform==="win32"?`${v.eraseScreen}${D}0f`:`${v.eraseScreen}${D}3J${D}H`;v.beep=dr;v.link=(e,r)=>[Vr,"8",Ft,Ft,r,dr,e,Vr,"8",Ft,Ft,dr].join("");v.image=(e,r={})=>{let t=`${Vr}1337;File=inline=1`;return r.width&&(t+=`;width=${r.width}`),r.height&&(t+=`;height=${r.height}`),r.preserveAspectRatio===!1&&(t+=";preserveAspectRatio=0"),t+":"+e.toString("base64")+dr};v.iTerm={setCwd:(e=process.cwd())=>`${Vr}50;CurrentDir=${e}${dr}`,annotation:(e,r={})=>{let t=`${Vr}1337;`,n=typeof r.x<"u",i=typeof r.y<"u";if((n||i)&&!(n&&i&&typeof r.length<"u"))throw new Error("`x`, `y` and `length` must be defined when `x` or `y` is defined");return e=e.replace(/\|/g,""),t+=r.isHidden?"AddHiddenAnnotation=":"AddAnnotation=",r.length>0?t+=(n?[e,r.length,r.x,r.y]:[r.length,e]).join("|"):t+=e,t+dr}}});var Qn=X((Nd,Io)=>{"use strict";Io.exports=(e,r=process.argv)=>{let t=e.startsWith("-")?"":e.length===1?"-":"--",n=r.indexOf(t+e),i=r.indexOf("--");return n!==-1&&(i===-1||n<i)}});var Do=X((Od,ko)=>{"use strict";var Cu=require("os"),_o=require("tty"),pe=Qn(),{env:G}=process,je;pe("no-color")||pe("no-colors")||pe("color=false")||pe("color=never")?je=0:(pe("color")||pe("colors")||pe("color=true")||pe("color=always"))&&(je=1);"FORCE_COLOR"in G&&(G.FORCE_COLOR==="true"?je=1:G.FORCE_COLOR==="false"?je=0:je=G.FORCE_COLOR.length===0?1:Math.min(parseInt(G.FORCE_COLOR,10),3));function Gn(e){return e===0?!1:{level:e,hasBasic:!0,has256:e>=2,has16m:e>=3}}function Jn(e,r){if(je===0)return 0;if(pe("color=16m")||pe("color=full")||pe("color=truecolor"))return 3;if(pe("color=256"))return 2;if(e&&!r&&je===void 0)return 0;let t=je||0;if(G.TERM==="dumb")return t;if(process.platform==="win32"){let n=Cu.release().split(".");return Number(n[0])>=10&&Number(n[2])>=10586?Number(n[2])>=14931?3:2:1}if("CI"in G)return["TRAVIS","CIRCLECI","APPVEYOR","GITLAB_CI","GITHUB_ACTIONS","BUILDKITE"].some(n=>n in G)||G.CI_NAME==="codeship"?1:t;if("TEAMCITY_VERSION"in G)return/^(9\.(0*[1-9]\d*)\.|\d{2,}\.)/.test(G.TEAMCITY_VERSION)?1:0;if(G.COLORTERM==="truecolor")return 3;if("TERM_PROGRAM"in G){let n=parseInt((G.TERM_PROGRAM_VERSION||"").split(".")[0],10);switch(G.TERM_PROGRAM){case"iTerm.app":return n>=3?3:2;case"Apple_Terminal":return 2}}return/-256(color)?$/i.test(G.TERM)?2:/^screen|^xterm|^vt100|^vt220|^rxvt|color|ansi|cygwin|linux/i.test(G.TERM)||"COLORTERM"in G?1:t}function Su(e){let r=Jn(e,e&&e.isTTY);return Gn(r)}ko.exports={supportsColor:Su,stdout:Gn(Jn(!0,_o.isatty(1))),stderr:Gn(Jn(!0,_o.isatty(2)))}});var Oo=X((Fd,No)=>{"use strict";var Ru=Do(),fr=Qn();function Lo(e){if(/^\d{3,4}$/.test(e)){let t=/(\d{1,2})(\d{2})/.exec(e);return{major:0,minor:parseInt(t[1],10),patch:parseInt(t[2],10)}}let r=(e||"").split(".").map(t=>parseInt(t,10));return{major:r[0],minor:r[1],patch:r[2]}}function Hn(e){let{env:r}=process;if("FORCE_HYPERLINK"in r)return!(r.FORCE_HYPERLINK.length>0&&parseInt(r.FORCE_HYPERLINK,10)===0);if(fr("no-hyperlink")||fr("no-hyperlinks")||fr("hyperlink=false")||fr("hyperlink=never"))return!1;if(fr("hyperlink=true")||fr("hyperlink=always")||"NETLIFY"in r)return!0;if(!Ru.supportsColor(e)||e&&!e.isTTY||process.platform==="win32"||"CI"in r||"TEAMCITY_VERSION"in r)return!1;if("TERM_PROGRAM"in r){let t=Lo(r.TERM_PROGRAM_VERSION);switch(r.TERM_PROGRAM){case"iTerm.app":return t.major===3?t.minor>=1:t.major>3;case"WezTerm":return t.major>=20200620;case"vscode":return t.major>1||t.major===1&&t.minor>=72}}if("VTE_VERSION"in r){if(r.VTE_VERSION==="0.50.0")return!1;let t=Lo(r.VTE_VERSION);return t.major>0||t.minor>=50}return!1}No.exports={supportsHyperlink:Hn,stdout:Hn(process.stdout),stderr:Hn(process.stderr)}});var Mo=X((Md,jr)=>{"use strict";var Au=Ao(),Wn=Oo(),Fo=(e,r,{target:t="stdout",...n}={})=>Wn[t]?Au.link(e,r):n.fallback===!1?e:typeof n.fallback=="function"?n.fallback(e,r):`${e} (\u200B${r}\u200B)`;jr.exports=(e,r,t={})=>Fo(e,r,t);jr.exports.stderr=(e,r,t={})=>Fo(e,r,{target:"stderr",...t});jr.exports.isSupported=Wn.stdout;jr.exports.stderr.isSupported=Wn.stderr});var qo=X((Hd,Iu)=>{Iu.exports={name:"dotenv",version:"16.0.3",description:"Loads environment variables from .env file",main:"lib/main.js",types:"lib/main.d.ts",exports:{".":{require:"./lib/main.js",types:"./lib/main.d.ts",default:"./lib/main.js"},"./config":"./config.js","./config.js":"./config.js","./lib/env-options":"./lib/env-options.js","./lib/env-options.js":"./lib/env-options.js","./lib/cli-options":"./lib/cli-options.js","./lib/cli-options.js":"./lib/cli-options.js","./package.json":"./package.json"},scripts:{"dts-check":"tsc --project tests/types/tsconfig.json",lint:"standard","lint-readme":"standard-markdown",pretest:"npm run lint && npm run dts-check",test:"tap tests/*.js --100 -Rspec",prerelease:"npm test",release:"standard-version"},repository:{type:"git",url:"git://github.com/motdotla/dotenv.git"},keywords:["dotenv","env",".env","environment","variables","config","settings"],readmeFilename:"README.md",license:"BSD-2-Clause",devDependencies:{"@types/node":"^17.0.9",decache:"^4.6.1",dtslint:"^3.7.0",sinon:"^12.0.1",standard:"^16.0.4","standard-markdown":"^7.1.0","standard-version":"^9.3.2",tap:"^15.1.6",tar:"^6.1.11",typescript:"^4.5.4"},engines:{node:">=12"}}});var Vo=X((Wd,$t)=>{"use strict";var _u=require("fs"),Bo=require("path"),ku=require("os"),Du=qo(),Lu=Du.version,Nu=/(?:^|^)\s*(?:export\s+)?([\w.-]+)(?:\s*=\s*?|:\s+?)(\s*'(?:\\'|[^'])*'|\s*"(?:\\"|[^"])*"|\s*`(?:\\`|[^`])*`|[^#\r\n]+)?\s*(?:#.*)?(?:$|$)/mg;function Ou(e){let r={},t=e.toString();t=t.replace(/\r\n?/mg,`
`);let n;for(;(n=Nu.exec(t))!=null;){let i=n[1],o=n[2]||"";o=o.trim();let s=o[0];o=o.replace(/^(['"`])([\s\S]*)\1$/mg,"$2"),s==='"'&&(o=o.replace(/\\n/g,`
`),o=o.replace(/\\r/g,"\r")),r[i]=o}return r}function zn(e){console.log(`[dotenv@${Lu}][DEBUG] ${e}`)}function Fu(e){return e[0]==="~"?Bo.join(ku.homedir(),e.slice(1)):e}function Mu(e){let r=Bo.resolve(process.cwd(),".env"),t="utf8",n=!!(e&&e.debug),i=!!(e&&e.override);e&&(e.path!=null&&(r=Fu(e.path)),e.encoding!=null&&(t=e.encoding));try{let o=Mt.parse(_u.readFileSync(r,{encoding:t}));return Object.keys(o).forEach(function(s){Object.prototype.hasOwnProperty.call(process.env,s)?(i===!0&&(process.env[s]=o[s]),n&&zn(i===!0?`"${s}" is already defined in \`process.env\` and WAS overwritten`:`"${s}" is already defined in \`process.env\` and was NOT overwritten`)):process.env[s]=o[s]}),{parsed:o}}catch(o){return n&&zn(`Failed to load ${r} ${o.message}`),{error:o}}}var Mt={config:Mu,parse:Ou};$t.exports.config=Mt.config;$t.exports.parse=Mt.parse;$t.exports=Mt});var Ho=X((rf,Jo)=>{"use strict";Jo.exports=e=>{let r=e.match(/^[ \t]*(?=\S)/gm);return r?r.reduce((t,n)=>Math.min(t,n.length),1/0):0}});var Ko=X((tf,Wo)=>{"use strict";var Vu=Ho();Wo.exports=e=>{let r=Vu(e);if(r===0)return e;let t=new RegExp(`^[ \\t]{${r}}`,"gm");return e.replace(t,"")}});var Xn=X((nf,ju)=>{ju.exports={name:"@prisma/engines-version",version:"5.11.0-9.3d9a0d64e7107d8985df64fce153a82e7821aeea",main:"index.js",types:"index.d.ts",license:"Apache-2.0",author:"Tim Suchanek <suchanek@prisma.io>",prisma:{enginesVersion:"3d9a0d64e7107d8985df64fce153a82e7821aeea"},repository:{type:"git",url:"https://github.com/prisma/engines-wrapper.git",directory:"packages/engines-version"},devDependencies:{"@types/node":"18.19.22",typescript:"4.9.5"},files:["index.js","index.d.ts"],scripts:{build:"tsc -d"}}});var ei=X(Bt=>{"use strict";Object.defineProperty(Bt,"__esModule",{value:!0});Bt.enginesVersion=void 0;Bt.enginesVersion=Xn().prisma.enginesVersion});var oi=X((Af,Zo)=>{"use strict";Zo.exports=(e,r=1,t)=>{if(t={indent:" ",includeEmptyLines:!1,...t},typeof e!="string")throw new TypeError(`Expected \`input\` to be a \`string\`, got \`${typeof e}\``);if(typeof r!="number")throw new TypeError(`Expected \`count\` to be a \`number\`, got \`${typeof r}\``);if(typeof t.indent!="string")throw new TypeError(`Expected \`options.indent\` to be a \`string\`, got \`${typeof t.indent}\``);if(r===0)return e;let n=t.includeEmptyLines?/^/gm:/^(?!\s*$)/gm;return e.replace(n,t.indent.repeat(r))}});var ts=X((kf,rs)=>{"use strict";rs.exports=({onlyFirst:e=!1}={})=>{let r=["[\\u001B\\u009B][[\\]()#;?]*(?:(?:(?:(?:;[-a-zA-Z\\d\\/#&.:=?%@~_]+)*|[a-zA-Z\\d]+(?:;[-a-zA-Z\\d\\/#&.:=?%@~_]*)*)?\\u0007)","(?:(?:\\d{1,4}(?:;\\d{0,4})*)?[\\dA-PR-TZcf-ntqry=><~]))"].join("|");return new RegExp(r,e?void 0:"g")}});var ui=X((Df,ns)=>{"use strict";var Zu=ts();ns.exports=e=>typeof e=="string"?e.replace(Zu(),""):e});var is=X((Of,jt)=>{"use strict";jt.exports=(e={})=>{let r;if(e.repoUrl)r=e.repoUrl;else if(e.user&&e.repo)r=`https://github.com/${e.user}/${e.repo}`;else throw new Error("You need to specify either the `repoUrl` option or both the `user` and `repo` options");let t=new URL(`${r}/issues/new`),n=["body","title","labels","template","milestone","assignee","projects"];for(let i of n){let o=e[i];if(o!==void 0){if(i==="labels"||i==="projects"){if(!Array.isArray(o))throw new TypeError(`The \`${i}\` option should be an array`);o=o.join(",")}t.searchParams.set(i,o)}}return t.toString()};jt.exports.default=jt.exports});var Wi=X((T0,Ba)=>{"use strict";Ba.exports=function(){function e(r,t,n,i,o){return r<t||n<t?r>n?n+1:r+1:i===o?t:t+1}return function(r,t){if(r===t)return 0;if(r.length>t.length){var n=r;r=t,t=n}for(var i=r.length,o=t.length;i>0&&r.charCodeAt(i-1)===t.charCodeAt(o-1);)i--,o--;for(var s=0;s<i&&r.charCodeAt(s)===t.charCodeAt(s);)s++;if(i-=s,o-=s,i===0||o<3)return o;var a=0,l,u,c,p,m,f,g,h,A,T,C,E,I=[];for(l=0;l<i;l++)I.push(l+1),I.push(r.charCodeAt(s+l));for(var me=I.length-1;a<o-3;)for(A=t.charCodeAt(s+(u=a)),T=t.charCodeAt(s+(c=a+1)),C=t.charCodeAt(s+(p=a+2)),E=t.charCodeAt(s+(m=a+3)),f=a+=4,l=0;l<me;l+=2)g=I[l],h=I[l+1],u=e(g,u,c,A,h),c=e(u,c,p,T,h),p=e(c,p,m,C,h),f=e(p,m,f,E,h),I[l]=f,m=p,p=c,c=u,u=g;for(;a<o;)for(A=t.charCodeAt(s+(u=a)),f=++a,l=0;l<me;l+=2)g=I[l],I[l]=f=e(g,u,f,A,I[l+1]),u=g;return f}}()});var sd={};Or(sd,{Debug:()=>On,Decimal:()=>Te,Extensions:()=>kn,MetricsClient:()=>yr,NotFoundError:()=>Le,PrismaClientInitializationError:()=>S,PrismaClientKnownRequestError:()=>V,PrismaClientRustPanicError:()=>ue,PrismaClientUnknownRequestError:()=>j,PrismaClientValidationError:()=>K,Public:()=>Dn,Sql:()=>oe,defineDmmfProperty:()=>ss,detectRuntime:()=>fn,empty:()=>ls,getPrismaClient:()=>Dl,join:()=>as,makeStrictEnum:()=>Ll,objectEnumValues:()=>Gt,raw:()=>Ei,sqltag:()=>bi,warnEnvConflicts:()=>Nl,warnOnce:()=>Wr});module.exports=Bl(sd);var kn={};Or(kn,{defineExtension:()=>io,getExtensionContext:()=>oo});function io(e){return typeof e=="function"?e:r=>r.$extends(e)}function oo(e){return e}var Dn={};Or(Dn,{validator:()=>so});function so(...e){return r=>r}var At={};Or(At,{$:()=>po,bgBlack:()=>zl,bgBlue:()=>eu,bgCyan:()=>tu,bgGreen:()=>Zl,bgMagenta:()=>ru,bgRed:()=>Yl,bgWhite:()=>nu,bgYellow:()=>Xl,black:()=>Jl,blue:()=>Ze,bold:()=>W,cyan:()=>_e,dim:()=>Ie,gray:()=>Fr,green:()=>$e,grey:()=>Kl,hidden:()=>Ql,inverse:()=>Ul,italic:()=>jl,magenta:()=>Hl,red:()=>ce,reset:()=>Vl,strikethrough:()=>Gl,underline:()=>ee,white:()=>Wl,yellow:()=>de});var Ln,ao,lo,uo,co=!0;typeof process<"u"&&({FORCE_COLOR:Ln,NODE_DISABLE_COLORS:ao,NO_COLOR:lo,TERM:uo}=process.env||{},co=process.stdout&&process.stdout.isTTY);var po={enabled:!ao&&lo==null&&uo!=="dumb"&&(Ln!=null&&Ln!=="0"||co)};function F(e,r){let t=new RegExp(`\\x1b\\[${r}m`,"g"),n=`\x1B[${e}m`,i=`\x1B[${r}m`;return function(o){return!po.enabled||o==null?o:n+(~(""+o).indexOf(i)?o.replace(t,i+n):o)+i}}var Vl=F(0,0),W=F(1,22),Ie=F(2,22),jl=F(3,23),ee=F(4,24),Ul=F(7,27),Ql=F(8,28),Gl=F(9,29),Jl=F(30,39),ce=F(31,39),$e=F(32,39),de=F(33,39),Ze=F(34,39),Hl=F(35,39),_e=F(36,39),Wl=F(37,39),Fr=F(90,39),Kl=F(90,39),zl=F(40,49),Yl=F(41,49),Zl=F(42,49),Xl=F(43,49),eu=F(44,49),ru=F(45,49),tu=F(46,49),nu=F(47,49);var iu=100,mo=["green","yellow","blue","magenta","cyan","red"],Mr=[],fo=Date.now(),ou=0,Nn=typeof process<"u"?process.env:{};globalThis.DEBUG??(globalThis.DEBUG=Nn.DEBUG??"");globalThis.DEBUG_COLORS??(globalThis.DEBUG_COLORS=Nn.DEBUG_COLORS?Nn.DEBUG_COLORS==="true":!0);var $r={enable(e){typeof e=="string"&&(globalThis.DEBUG=e)},disable(){let e=globalThis.DEBUG;return globalThis.DEBUG="",e},enabled(e){let r=globalThis.DEBUG.split(",").map(i=>i.replace(/[.+?^${}()|[\]\\]/g,"\\$&")),t=r.some(i=>i===""||i[0]==="-"?!1:e.match(RegExp(i.split("*").join(".*")+"$"))),n=r.some(i=>i===""||i[0]!=="-"?!1:e.match(RegExp(i.slice(1).split("*").join(".*")+"$")));return t&&!n},log:(...e)=>{let[r,t,...n]=e,i;typeof require=="function"&&typeof process<"u"&&typeof process.stderr<"u"&&typeof process.stderr.write=="function"?i=(...o)=>{let s=require("util");process.stderr.write(s.format(...o)+`
`)}:i=console.warn??console.log,i(`${r} ${t}`,...n)},formatters:{}};function su(e){let r={color:mo[ou++%mo.length],enabled:$r.enabled(e),namespace:e,log:$r.log,extend:()=>{}},t=(...n)=>{let{enabled:i,namespace:o,color:s,log:a}=r;if(n.length!==0&&Mr.push([o,...n]),Mr.length>iu&&Mr.shift(),$r.enabled(o)||i){let l=n.map(c=>typeof c=="string"?c:au(c)),u=`+${Date.now()-fo}ms`;fo=Date.now(),globalThis.DEBUG_COLORS?a(At[s](W(o)),...l,At[s](u)):a(o,...l,u)}};return new Proxy(t,{get:(n,i)=>r[i],set:(n,i,o)=>r[i]=o})}var On=new Proxy(su,{get:(e,r)=>$r[r],set:(e,r,t)=>$r[r]=t});function au(e,r=2){let t=new Set;return JSON.stringify(e,(n,i)=>{if(typeof i=="object"&&i!==null){if(t.has(i))return"[Circular *]";t.add(i)}else if(typeof i=="bigint")return i.toString();return i},r)}function go(e=7500){let r=Mr.map(([t,...n])=>`${t} ${n.map(i=>typeof i=="string"?i:JSON.stringify(i)).join(" ")}`).join(`
`);return r.length<e?r:r.slice(-e)}function ho(){Mr.length=0}var N=On;var yo=_(require("fs"));function Fn(){let e=process.env.PRISMA_QUERY_ENGINE_LIBRARY;if(!(e&&yo.default.existsSync(e))&&process.arch==="ia32")throw new Error('The default query engine type (Node-API, "library") is currently not supported for 32bit Node. Please set `engineType = "binary"` in the "generator" block of your "schema.prisma" file (or use the environment variables "PRISMA_CLIENT_ENGINE_TYPE=binary" and/or "PRISMA_CLI_QUERY_ENGINE_TYPE=binary".)')}var Mn=["darwin","darwin-arm64","debian-openssl-1.0.x","debian-openssl-1.1.x","debian-openssl-3.0.x","rhel-openssl-1.0.x","rhel-openssl-1.1.x","rhel-openssl-3.0.x","linux-arm64-openssl-1.1.x","linux-arm64-openssl-1.0.x","linux-arm64-openssl-3.0.x","linux-arm-openssl-1.1.x","linux-arm-openssl-1.0.x","linux-arm-openssl-3.0.x","linux-musl","linux-musl-openssl-3.0.x","linux-musl-arm64-openssl-1.1.x","linux-musl-arm64-openssl-3.0.x","linux-nixos","linux-static-x64","linux-static-arm64","windows","freebsd11","freebsd12","freebsd13","freebsd14","freebsd15","openbsd","netbsd","arm"];var It="libquery_engine";function _t(e,r){let t=r==="url";return e.includes("windows")?t?"query_engine.dll.node":`query_engine-${e}.dll.node`:e.includes("darwin")?t?`${It}.dylib.node`:`${It}-${e}.dylib.node`:t?`${It}.so.node`:`${It}-${e}.so.node`}var xo=_(require("child_process")),Vn=_(require("fs/promises")),Nt=_(require("os"));var ke=Symbol.for("@ts-pattern/matcher"),lu=Symbol.for("@ts-pattern/isVariadic"),Dt="@ts-pattern/anonymous-select-key",$n=e=>!!(e&&typeof e=="object"),kt=e=>e&&!!e[ke],we=(e,r,t)=>{if(kt(e)){let n=e[ke](),{matched:i,selections:o}=n.match(r);return i&&o&&Object.keys(o).forEach(s=>t(s,o[s])),i}if($n(e)){if(!$n(r))return!1;if(Array.isArray(e)){if(!Array.isArray(r))return!1;let n=[],i=[],o=[];for(let s of e.keys()){let a=e[s];kt(a)&&a[lu]?o.push(a):o.length?i.push(a):n.push(a)}if(o.length){if(o.length>1)throw new Error("Pattern error: Using `...P.array(...)` several times in a single pattern is not allowed.");if(r.length<n.length+i.length)return!1;let s=r.slice(0,n.length),a=i.length===0?[]:r.slice(-i.length),l=r.slice(n.length,i.length===0?1/0:-i.length);return n.every((u,c)=>we(u,s[c],t))&&i.every((u,c)=>we(u,a[c],t))&&(o.length===0||we(o[0],l,t))}return e.length===r.length&&e.every((s,a)=>we(s,r[a],t))}return Object.keys(e).every(n=>{let i=e[n];return(n in r||kt(o=i)&&o[ke]().matcherType==="optional")&&we(i,r[n],t);var o})}return Object.is(r,e)},Ve=e=>{var r,t,n;return $n(e)?kt(e)?(r=(t=(n=e[ke]()).getSelectionKeys)==null?void 0:t.call(n))!=null?r:[]:Array.isArray(e)?qr(e,Ve):qr(Object.values(e),Ve):[]},qr=(e,r)=>e.reduce((t,n)=>t.concat(r(n)),[]);function fe(e){return Object.assign(e,{optional:()=>uu(e),and:r=>B(e,r),or:r=>cu(e,r),select:r=>r===void 0?Eo(e):Eo(r,e)})}function uu(e){return fe({[ke]:()=>({match:r=>{let t={},n=(i,o)=>{t[i]=o};return r===void 0?(Ve(e).forEach(i=>n(i,void 0)),{matched:!0,selections:t}):{matched:we(e,r,n),selections:t}},getSelectionKeys:()=>Ve(e),matcherType:"optional"})})}function B(...e){return fe({[ke]:()=>({match:r=>{let t={},n=(i,o)=>{t[i]=o};return{matched:e.every(i=>we(i,r,n)),selections:t}},getSelectionKeys:()=>qr(e,Ve),matcherType:"and"})})}function cu(...e){return fe({[ke]:()=>({match:r=>{let t={},n=(i,o)=>{t[i]=o};return qr(e,Ve).forEach(i=>n(i,void 0)),{matched:e.some(i=>we(i,r,n)),selections:t}},getSelectionKeys:()=>qr(e,Ve),matcherType:"or"})})}function k(e){return{[ke]:()=>({match:r=>({matched:!!e(r)})})}}function Eo(...e){let r=typeof e[0]=="string"?e[0]:void 0,t=e.length===2?e[1]:typeof e[0]=="string"?void 0:e[0];return fe({[ke]:()=>({match:n=>{let i={[r??Dt]:n};return{matched:t===void 0||we(t,n,(o,s)=>{i[o]=s}),selections:i}},getSelectionKeys:()=>[r??Dt].concat(t===void 0?[]:Ve(t))})})}function Ee(e){return typeof e=="number"}function Xe(e){return typeof e=="string"}function qe(e){return typeof e=="bigint"}var bd=fe(k(function(e){return!0}));var er=e=>Object.assign(fe(e),{startsWith:r=>{return er(B(e,(t=r,k(n=>Xe(n)&&n.startsWith(t)))));var t},endsWith:r=>{return er(B(e,(t=r,k(n=>Xe(n)&&n.endsWith(t)))));var t},minLength:r=>er(B(e,(t=>k(n=>Xe(n)&&n.length>=t))(r))),maxLength:r=>er(B(e,(t=>k(n=>Xe(n)&&n.length<=t))(r))),includes:r=>{return er(B(e,(t=r,k(n=>Xe(n)&&n.includes(t)))));var t},regex:r=>{return er(B(e,(t=r,k(n=>Xe(n)&&!!n.match(t)))));var t}}),wd=er(k(Xe)),be=e=>Object.assign(fe(e),{between:(r,t)=>be(B(e,((n,i)=>k(o=>Ee(o)&&n<=o&&i>=o))(r,t))),lt:r=>be(B(e,(t=>k(n=>Ee(n)&&n<t))(r))),gt:r=>be(B(e,(t=>k(n=>Ee(n)&&n>t))(r))),lte:r=>be(B(e,(t=>k(n=>Ee(n)&&n<=t))(r))),gte:r=>be(B(e,(t=>k(n=>Ee(n)&&n>=t))(r))),int:()=>be(B(e,k(r=>Ee(r)&&Number.isInteger(r)))),finite:()=>be(B(e,k(r=>Ee(r)&&Number.isFinite(r)))),positive:()=>be(B(e,k(r=>Ee(r)&&r>0))),negative:()=>be(B(e,k(r=>Ee(r)&&r<0)))}),xd=be(k(Ee)),Be=e=>Object.assign(fe(e),{between:(r,t)=>Be(B(e,((n,i)=>k(o=>qe(o)&&n<=o&&i>=o))(r,t))),lt:r=>Be(B(e,(t=>k(n=>qe(n)&&n<t))(r))),gt:r=>Be(B(e,(t=>k(n=>qe(n)&&n>t))(r))),lte:r=>Be(B(e,(t=>k(n=>qe(n)&&n<=t))(r))),gte:r=>Be(B(e,(t=>k(n=>qe(n)&&n>=t))(r))),positive:()=>Be(B(e,k(r=>qe(r)&&r>0))),negative:()=>Be(B(e,k(r=>qe(r)&&r<0)))}),Pd=Be(k(qe)),vd=fe(k(function(e){return typeof e=="boolean"})),Td=fe(k(function(e){return typeof e=="symbol"})),Cd=fe(k(function(e){return e==null}));var qn={matched:!1,value:void 0};function mr(e){return new Bn(e,qn)}var Bn=class e{constructor(r,t){this.input=void 0,this.state=void 0,this.input=r,this.state=t}with(...r){if(this.state.matched)return this;let t=r[r.length-1],n=[r[0]],i;r.length===3&&typeof r[1]=="function"?i=r[1]:r.length>2&&n.push(...r.slice(1,r.length-1));let o=!1,s={},a=(u,c)=>{o=!0,s[u]=c},l=!n.some(u=>we(u,this.input,a))||i&&!i(this.input)?qn:{matched:!0,value:t(o?Dt in s?s[Dt]:s:this.input,this.input)};return new e(this.input,l)}when(r,t){if(this.state.matched)return this;let n=!!r(this.input);return new e(this.input,n?{matched:!0,value:t(this.input,this.input)}:qn)}otherwise(r){return this.state.matched?this.state.value:r(this.input)}exhaustive(){if(this.state.matched)return this.state.value;let r;try{r=JSON.stringify(this.input)}catch{r=this.input}throw new Error(`Pattern matching error: no pattern matches value ${r}`)}run(){return this.exhaustive()}returnType(){return this}};var Po=require("util");var pu={warn:de("prisma:warn")},mu={warn:()=>!process.env.PRISMA_DISABLE_WARNINGS};function Br(e,...r){mu.warn()&&console.warn(`${pu.warn} ${e}`,...r)}var du=(0,Po.promisify)(xo.default.exec),ie=N("prisma:get-platform"),fu=["1.0.x","1.1.x","3.0.x"];async function vo(){let e=Nt.default.platform(),r=process.arch;if(e==="freebsd"){let s=await Ot("freebsd-version");if(s&&s.trim().length>0){let l=/^(\d+)\.?/.exec(s);if(l)return{platform:"freebsd",targetDistro:`freebsd${l[1]}`,arch:r}}}if(e!=="linux")return{platform:e,arch:r};let t=await hu(),n=await Tu(),i=Eu({arch:r,archFromUname:n,familyDistro:t.familyDistro}),{libssl:o}=await bu(i);return{platform:"linux",libssl:o,arch:r,archFromUname:n,...t}}function gu(e){let r=/^ID="?([^"\n]*)"?$/im,t=/^ID_LIKE="?([^"\n]*)"?$/im,n=r.exec(e),i=n&&n[1]&&n[1].toLowerCase()||"",o=t.exec(e),s=o&&o[1]&&o[1].toLowerCase()||"",a=mr({id:i,idLike:s}).with({id:"alpine"},({id:l})=>({targetDistro:"musl",familyDistro:l,originalDistro:l})).with({id:"raspbian"},({id:l})=>({targetDistro:"arm",familyDistro:"debian",originalDistro:l})).with({id:"nixos"},({id:l})=>({targetDistro:"nixos",originalDistro:l,familyDistro:"nixos"})).with({id:"debian"},{id:"ubuntu"},({id:l})=>({targetDistro:"debian",familyDistro:"debian",originalDistro:l})).with({id:"rhel"},{id:"centos"},{id:"fedora"},({id:l})=>({targetDistro:"rhel",familyDistro:"rhel",originalDistro:l})).when(({idLike:l})=>l.includes("debian")||l.includes("ubuntu"),({id:l})=>({targetDistro:"debian",familyDistro:"debian",originalDistro:l})).when(({idLike:l})=>i==="arch"||l.includes("arch"),({id:l})=>({targetDistro:"debian",familyDistro:"arch",originalDistro:l})).when(({idLike:l})=>l.includes("centos")||l.includes("fedora")||l.includes("rhel")||l.includes("suse"),({id:l})=>({targetDistro:"rhel",familyDistro:"rhel",originalDistro:l})).otherwise(({id:l})=>({targetDistro:void 0,familyDistro:void 0,originalDistro:l}));return ie(`Found distro info:
${JSON.stringify(a,null,2)}`),a}async function hu(){let e="/etc/os-release";try{let r=await Vn.default.readFile(e,{encoding:"utf-8"});return gu(r)}catch{return{targetDistro:void 0,familyDistro:void 0,originalDistro:void 0}}}function yu(e){let r=/^OpenSSL\s(\d+\.\d+)\.\d+/.exec(e);if(r){let t=`${r[1]}.x`;return To(t)}}function bo(e){let r=/libssl\.so\.(\d)(\.\d)?/.exec(e);if(r){let t=`${r[1]}${r[2]??".0"}.x`;return To(t)}}function To(e){let r=(()=>{if(So(e))return e;let t=e.split(".");return t[1]="0",t.join(".")})();if(fu.includes(r))return r}function Eu(e){return mr(e).with({familyDistro:"musl"},()=>(ie('Trying platform-specific paths for "alpine"'),["/lib"])).with({familyDistro:"debian"},({archFromUname:r})=>(ie('Trying platform-specific paths for "debian" (and "ubuntu")'),[`/usr/lib/${r}-linux-gnu`,`/lib/${r}-linux-gnu`])).with({familyDistro:"rhel"},()=>(ie('Trying platform-specific paths for "rhel"'),["/lib64","/usr/lib64"])).otherwise(({familyDistro:r,arch:t,archFromUname:n})=>(ie(`Don't know any platform-specific paths for "${r}" on ${t} (${n})`),[]))}async function bu(e){let r='grep -v "libssl.so.0"',t=await wo(e);if(t){ie(`Found libssl.so file using platform-specific paths: ${t}`);let o=bo(t);if(ie(`The parsed libssl version is: ${o}`),o)return{libssl:o,strategy:"libssl-specific-path"}}ie('Falling back to "ldconfig" and other generic paths');let n=await Ot(`ldconfig -p | sed "s/.*=>s*//" | sed "s|.*/||" | grep libssl | sort | ${r}`);if(n||(n=await wo(["/lib64","/usr/lib64","/lib"])),n){ie(`Found libssl.so file using "ldconfig" or other generic paths: ${n}`);let o=bo(n);if(ie(`The parsed libssl version is: ${o}`),o)return{libssl:o,strategy:"ldconfig"}}let i=await Ot("openssl version -v");if(i){ie(`Found openssl binary with version: ${i}`);let o=yu(i);if(ie(`The parsed openssl version is: ${o}`),o)return{libssl:o,strategy:"openssl-binary"}}return ie("Couldn't find any version of libssl or OpenSSL in the system"),{}}async function wo(e){for(let r of e){let t=await wu(r);if(t)return t}}async function wu(e){try{return(await Vn.default.readdir(e)).find(t=>t.startsWith("libssl.so.")&&!t.startsWith("libssl.so.0"))}catch(r){if(r.code==="ENOENT")return;throw r}}async function rr(){let{binaryTarget:e}=await Co();return e}function xu(e){return e.binaryTarget!==void 0}async function jn(){let{memoized:e,...r}=await Co();return r}var Lt={};async function Co(){if(xu(Lt))return Promise.resolve({...Lt,memoized:!0});let e=await vo(),r=Pu(e);return Lt={...e,binaryTarget:r},{...Lt,memoized:!1}}function Pu(e){let{platform:r,arch:t,archFromUname:n,libssl:i,targetDistro:o,familyDistro:s,originalDistro:a}=e;r==="linux"&&!["x64","arm64"].includes(t)&&Br(`Prisma only officially supports Linux on amd64 (x86_64) and arm64 (aarch64) system architectures. If you are using your own custom Prisma engines, you can ignore this warning, as long as you've compiled the engines for your system architecture "${n}".`);let l="1.1.x";if(r==="linux"&&i===void 0){let c=mr({familyDistro:s}).with({familyDistro:"debian"},()=>"Please manually install OpenSSL via `apt-get update -y && apt-get install -y openssl` and try installing Prisma again. If you're running Prisma on Docker, add this command to your Dockerfile, or switch to an image that already has OpenSSL installed.").otherwise(()=>"Please manually install OpenSSL and try installing Prisma again.");Br(`Prisma failed to detect the libssl/openssl version to use, and may not work as expected. Defaulting to "openssl-${l}".
${c}`)}let u="debian";if(r==="linux"&&o===void 0&&Br(`Prisma doesn't know which engines to download for the Linux distro "${a}". Falling back to Prisma engines built "${u}".`),r==="darwin"&&t==="arm64")return"darwin-arm64";if(r==="darwin")return"darwin";if(r==="win32")return"windows";if(r==="freebsd")return o;if(r==="openbsd")return"openbsd";if(r==="netbsd")return"netbsd";if(r==="linux"&&o==="nixos")return"linux-nixos";if(r==="linux"&&t==="arm64")return`${o==="musl"?"linux-musl-arm64":"linux-arm64"}-openssl-${i||l}`;if(r==="linux"&&t==="arm")return`linux-arm-openssl-${i||l}`;if(r==="linux"&&o==="musl"){let c="linux-musl";return!i||So(i)?c:`${c}-openssl-${i}`}return r==="linux"&&o&&i?`${o}-openssl-${i}`:(r!=="linux"&&Br(`Prisma detected unknown OS "${r}" and may not work as expected. Defaulting to "linux".`),i?`${u}-openssl-${i}`:o?`${o}-openssl-${l}`:`${u}-openssl-${l}`)}async function vu(e){try{return await e()}catch{return}}function Ot(e){return vu(async()=>{let r=await du(e);return ie(`Command "${e}" successfully returned "${r.stdout}"`),r.stdout})}async function Tu(){return typeof Nt.default.machine=="function"?Nt.default.machine():(await Ot("uname -m"))?.trim()}function So(e){return e.startsWith("1.")}var $o=_(Mo());function Kn(e){return(0,$o.default)(e,e,{fallback:ee})}var Zn=_(Vo()),qt=_(require("fs"));var gr=_(require("path"));function jo(e){let r=e.ignoreProcessEnv?{}:process.env,t=n=>n.match(/(.?\${(?:[a-zA-Z0-9_]+)?})/g)?.reduce(function(o,s){let a=/(.?)\${([a-zA-Z0-9_]+)?}/g.exec(s);if(!a)return o;let l=a[1],u,c;if(l==="\\")c=a[0],u=c.replace("\\$","$");else{let p=a[2];c=a[0].substring(l.length),u=Object.hasOwnProperty.call(r,p)?r[p]:e.parsed[p]||"",u=t(u)}return o.replace(c,u)},n)??n;for(let n in e.parsed){let i=Object.hasOwnProperty.call(r,n)?r[n]:e.parsed[n];e.parsed[n]=t(i)}for(let n in e.parsed)r[n]=e.parsed[n];return e}var Yn=N("prisma:tryLoadEnv");function Ur({rootEnvPath:e,schemaEnvPath:r},t={conflictCheck:"none"}){let n=Uo(e);t.conflictCheck!=="none"&&$u(n,r,t.conflictCheck);let i=null;return Qo(n?.path,r)||(i=Uo(r)),!n&&!i&&Yn("No Environment variables loaded"),i?.dotenvResult.error?console.error(ce(W("Schema Env Error: "))+i.dotenvResult.error):{message:[n?.message,i?.message].filter(Boolean).join(`
`),parsed:{...n?.dotenvResult?.parsed,...i?.dotenvResult?.parsed}}}function $u(e,r,t){let n=e?.dotenvResult.parsed,i=!Qo(e?.path,r);if(n&&r&&i&&qt.default.existsSync(r)){let o=Zn.default.parse(qt.default.readFileSync(r)),s=[];for(let a in o)n[a]===o[a]&&s.push(a);if(s.length>0){let a=gr.default.relative(process.cwd(),e.path),l=gr.default.relative(process.cwd(),r);if(t==="error"){let u=`There is a conflict between env var${s.length>1?"s":""} in ${ee(a)} and ${ee(l)}
...
We detected that you are using Next.js, learn how to fix this: https://pris.ly/d/engine-not-found-nextjs.`:""}function fa(e){let{queryEngineName:r}=e;return`${Ke(e)}${yn(e)}
...
${ze(e)}`}function ga(e){let{runtimeBinaryTarget:r,generatorBinaryTargets:t}=e,n=t.find(i=>i.native);return`${Ke(e)}

This happened because Prisma Client was generated for "${n?.value??"unknown"}", but the actual deployment required "${r}".
${gn(e)}

${ze(e)}`}function ha(e){let{queryEngineName:r}=e;return`${Ke(e)}${yn(e)}
...
${ze(e)}`}var Wp=N("prisma:client:engines:resolveEnginePath"),Kp=()=>new RegExp("runtime[\\\\/]library\\.m?js$");async function Ea(e,r){let t={binary:process.env.PRISMA_QUERY_ENGINE_BINARY,library:process.env.PRISMA_QUERY_ENGINE_LIBRARY}[e]??r.prismaPath;if(t!==void 0)return t;let{enginePath:n,searchedLocations:i}=await zp(e,r);if(Wp("enginePath",n),n!==void 0&&e==="binary"&&ti(n),n!==void 0)return r.prismaPath=n;let o=await rr(),s=r.generator?.binaryTargets??[],a=s.some(m=>m.native),l=!s.some(m=>m.value===o),u=__filename.match(Kp())===null,c={searchedLocations:i,generatorBinaryTargets:s,generator:r.generator,runtimeBinaryTarget:o,queryEngineName:ba(e,o),expectedLocation:lt.default.relative(process.cwd(),r.dirname),errorStack:new Error().stack},p;throw a&&l?p=ga(c):l?p=da(c):u?p=fa(c):p=ha(c),new S(p,r.clientVersion)}async function zp(engineType,config){let binaryTarget=await rr(),searchedLocations=[],dirname=eval("__dirname"),searchLocations=[config.dirname,lt.default.resolve(dirname,".."),config.generator?.output?.value??dirname,lt.default.resolve(dirname,"../../../.prisma/client"),"/tmp/prisma-engines",config.cwd];__filename.includes("resolveEnginePath")&&searchLocations.push(zo());for(let e of searchLocations){let r=ba(engineType,binaryTarget),t=lt.default.join(e,r);if(searchedLocations.push(e),ya.default.existsSync(t))return{enginePath:t,searchedLocations}}return{enginePath:void 0,searchedLocations}}function ba(e,r){return e==="library"?_t(r,"fs"):`query-engine-${r}${r==="windows"?".exe":""}`}var Li=_(ui());function wa(e){return e?e.replace(/".*"/g,'"X"').replace(/[\s:\[]([+-]?([0-9]*[.])?[0-9]+)/g,r=>`${r[0]}5`):""}function xa(e){return e.split(`
`).map(r=>r.replace(/^\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+([+-][0-2]\d:[0-5]\d|Z)\s*/,"").replace(/\+\d+\s*ms$/,"")).join(`
`)}var Pa=_(is());function va({title:e,user:r="prisma",repo:t="prisma",template:n="bug_report.yml",body:i}){return(0,Pa.default)({user:r,repo:t,template:n,title:e,body:i})}function Ta({version:e,binaryTarget:r,title:t,description:n,engineVersion:i,database:o,query:s}){let a=go(6e3-(s?.length??0)),l=xa((0,Li.default)(a)),u=n?`# Description
\`\`\`
${n}
